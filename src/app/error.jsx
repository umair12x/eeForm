...
import { AlertTriangle, Zap, Phone, RefreshCw } from 'lucide-react';
...
export default function GlobalError({ error, reset }) {
  ...
  return (
    <html>
      <body className="bg-gradient-to-br from-red-50 to-orange-50 dark:from-gray-900 dark:to-gray-800">
          ...
          >
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-center text-gray-600 dark:text-gray-400 mb-6">
                We're experiencing a critical system error. Our engineers have been notified.
              </p>
              ...
              {process.env.NODE_ENV === 'development' && error?.message && (
                <div className="mb-6 p-4 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
                  ...
                  <p className="text-xs font-mono text-red-700 dark:text-red-300 overflow-auto max-h-24 break-words">
                    {error.message}
                  </p>
                </div>
              )}
              ...
              <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                <div className="flex items-center justify-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <span>Support: +92-XXX-XXXXXXX</span>
                </div>
              </div>
            </div>
          </motion.div>
