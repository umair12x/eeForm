...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    { name: 'Twitter', icon: Twitter, href: 'https://twitter.com', color: 'hover:bg-sky-500 hover:text-white' },
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-slate-900 dark:text-white">support@uaf.edu.pk</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-slate-900 dark:text-white">+92 41 9200000</p>
                </div>
              </a>
              ...
              <div className="flex items-center gap-3 p-3 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
                ...
                <div>
                  <p className="text-xs text-slate-500 dark:text-slate-400 uppercase tracking-wider">Office Hours</p>
                  <p className="text-sm font-medium text-slate-900 dark:text-white">Mon - Fri: 8:00 AM - 5:00 PM</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-8">
            ...
            <div className="mt-8 pt-8 border-t border-slate-200 dark:border-slate-800">
              <div className="flex items-start gap-3 text-sm text-slate-600 dark:text-slate-400">
                ...
                <div>
                  <p className="font-medium text-slate-900 dark:text-white">University of Agriculture, Faisalabad</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400">
              <span>© {currentYear} University of Agriculture, Faisalabad.</span>
              <span className="hidden sm:inline">•</span>
              <span className="hidden sm:flex items-center gap-1">
                Made with <Heart className="w-3 h-3 text-rose-500 fill-rose-500" /> in Pakistan
              </span>
            </div>
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`w-9 h-9 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 flex items-center justify-center transition-all duration-200 ${social.color}`}
